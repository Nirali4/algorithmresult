...
public class AlgorithmServiceImpl implements AlgorithmService {
    ...
    @Override
    public void runResult(final Results algorithm) {
    ...
    public void updateResult() {
        ...
        for(final Result result : algorithmRepository.findAll()) {
    ...
    try{
        if(json != null) {
            final double resultAPI = json.getJSONObject("ticker").getDouble("price");
            final Result algorithm = new Result(resultAPI);
    ...
    System.out.println("Updated: " + result);
     ...
     @Override
     public List<Result> getAlgorithmResult() {
         return AlgorithmRepository.findAllWithRecentPrices();
     }
    }